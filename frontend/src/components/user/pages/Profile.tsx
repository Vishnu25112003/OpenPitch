...
const Profile: React.FC = () => {
  ...
  return (
    <div>
      <h1 className="text-4xl flex justify-center pt-15 text-blue-500 font-bold">Profile</h1>
        ...
        <div className="flex justify-center pt-8">
          <div className="bg-gray-100 p-6 rounded-lg shadow-lg w-96 text-left">
            ...
            <p className="mb-2">
              ...
              <input type="text" value={profile.name} readOnly className="w-full border border-gray-300 p-2 rounded" />
            </p>
            <p className="mb-2">
              <label className="text-blue-600">Email:</label>
              <input type="text" value={profile.email} readOnly className="w-full border border-gray-300 p-2 rounded" />
            </p>
            <p className="mb-2">
              <label className="text-blue-600">Phone:</label>
              <input type="text" value={profile.phone} readOnly className="w-full border border-gray-300 p-2 rounded" />
            </p>
          </div>
        </div>
      )}
...
//                 <input type="text" value={user.name} className="mb-2 border border-gray-300 p-2 rounded" />
//               </p>
//               <p className="mb-2">
//                 <label htmlFor="email" className="text-blue-600">Email:</label>
//                 <input type="text" value={user.email} className="mb-2 border border-gray-300 p-2 rounded" />
//               </p>
//               <p className="mb-2">
//                 <label htmlFor="phone" className="text-blue-600">Phone:</label>
//                 <input type="text" value={user.phone} className="mb-2 border border-gray-300 p-2 rounded" />
//               </p>
//             </div>
//           </div>
//         ))}
